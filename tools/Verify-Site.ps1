...
$Checks = @(
  ...
  @{ Path = "/study/"; Text = "Study Card & Planner Lab" },
  @{ Path = "/study/manifest.webmanifest"; Text = "Study Card & Planner Lab" },
  @{ Path = "/study/word-bank.js"; Text = "STUDY_WORD_BANK" },
  @{ Path = "/study/sw.js"; Text = "study-lab-v2" },
  @{ Path = "/study/sitemap.xml"; Text = "https://dhforge.github.io/study/" },
