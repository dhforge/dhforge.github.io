...
Use this after publishing changes to GitHub Pages.

## URL Checks

- Open `https://dhforge.github.io/`
- Open `https://dhforge.github.io/en/`
- Open `https://dhforge.github.io/paper/`
...
- Inspect `/paper/ko/`
- Inspect `/paper/ko/graph-paper/`
- Inspect `/paper/ko/guides/graph-paper.html`
- Inspect `/about.html`
- Inspect `/kids/about.html`

## Manual QA

- Switch languages from Korean to English and back.
